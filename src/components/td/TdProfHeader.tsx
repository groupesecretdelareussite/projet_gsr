    ...
    <header className="sticky top-0 z-40 bg-white border-b border-gray-100 shadow-xs">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-2.5 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <Link href="/td/prof/dashboard" className="flex items-center gap-2.5 group">
        ...
        <div className="hidden md:flex items-center gap-2 shrink-0">
          <Link
            href="/td/prof/aide"
            title="Aide & Guide Professeur"
            className={cn(
              "flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-medium transition-colors",
              isItemActive("/td/prof/aide")
          ...
          <aside className="absolute right-0 top-0 h-full w-[290px] max-w-[85vw] bg-white shadow-2xl flex flex-col animate-in slide-in-from-right duration-200">
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100 bg-surface/50">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <span className="text-[11px] font-semibold text-primary">Espace Professeur</span>
                </div>
              </div>
              <button
                type="button"
            ...
            <div className="flex-1 overflow-y-auto px-3 py-4 space-y-1">
              ...
              <div className="pt-4 mt-4 border-t border-gray-100">
                ...
                >
                  ...
                  <span>Aide & Guide Professeur</span>
                </Link>
              </div>
            </div>
            ...
            <div className="p-4 border-t border-gray-100 bg-surface/30">
              ...
              >
                ...
                <span>{isPending ? "Déconnexion en cours..." : "Se déconnecter"}</span>
              </button>
            </div>
          </aside>
        </div>
